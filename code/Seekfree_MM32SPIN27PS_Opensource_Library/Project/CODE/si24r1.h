...
//-----------------------SI24R1引脚配置-------------------------//
#define NRF_SPI_NUM				SPI_1
#define NRF_CE_PIN          	B13
#define NRF_CSN_PIN         	D2
#define NRF_SCK_PIN         	SPI1_SCK_D03
#define NRF_MOSI_PIN        	SPI1_MOSI_D04                            
#define NRF_MISO_PIN        	SPI1_MISO_D05
#define NRF_IRQ_PIN         	B12


#define SI24R1_CS(x)		((x == 0)? (GPIO_PIN_RESET(SI24R1_CSN_PIN))  :(GPIO_PIN_SET(SI24R1_CSN_PIN)))
#define SI24R1_CE(x)		((x == 0)? (GPIO_PIN_RESET(SI24R1_CE_PIN))  :(GPIO_PIN_SET(SI24R1_CE_PIN)))
