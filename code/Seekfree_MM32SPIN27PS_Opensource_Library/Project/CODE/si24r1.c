#include "si24r1.h"
uint8 NRF_RF_Addr[NRF_ADDR_WIDTH]={0x01,0x23,0x45,0x67,0xfe};   // TX,RX地址,可自行更改
...
void NRF_Dev_Init(void)
{
	...
	spi_init(NRF_SPI_NUM, NRF_SCK_PIN, NRF_MOSI_PIN, NRF_MISO_PIN, SPI_NSS_NULL, 0, SystemCoreClock/8);	// 硬件SPI初始化
